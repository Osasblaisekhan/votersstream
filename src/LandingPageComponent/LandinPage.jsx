        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center space-x-3 text-white">
             ...
             <div>
               <h3 className="md:text-2xl font-bold text-white">Voters Stream</h3>
             </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            <h1 className="text-5xl font-bold text-gray-900 mb-6">
              ...
              <span className="block text-indigo-600">for a Brighter Future</span>
            </h1>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 items-center justify-between">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-xl font-bold">Voters Stream</h3>
              </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-white">
            <h3 className='text-white'>&copy; 2025 Voters Stream. All rights reserved.</h3>
          </div>
        </div>
      </footer>
    </div>
